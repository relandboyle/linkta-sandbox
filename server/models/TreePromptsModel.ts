...
const TreePrompts = {
  ...
  costar(prompt: string): string {
    ...
    '{"nodes":[{"id":"1","type":"input","data":{"label":"System Design"},"position":{"x":0,"y":0}},{"id":"2","data":{"label":"Principles"},"position":{"x":0,"y":0},"parentId":"1"},{"id":"3","data":{"label":"Patterns"},"position":{"x":0,"y":0},"parentId":"1"},{"id":"4","data":{"label":"Scalability"},"position":{"x":0,"y":0},"parentId":"2"},{"id":"5","data":{"label":"Reliability"},"position":{"x":0,"y":0},"parentId":"2"},{"id":"6","data":{"label":"MVC"},"position":{"x":0,"y":0},"parentId":"3"},{"id":"7","data":{"label":"Microservices"},"position":{"x":0,"y":0},"parentId":"3"}],"edges":[{"id":"e1-2","source":"1","target":"2","type":"smoothstep"},{"id":"e1-3","source":"1","target":"3","type":"smoothstep"},{"id":"e2-4","source":"2","target":"4","type":"smoothstep"},{"id":"e2-5","source":"2","target":"5","type":"smoothstep"},{"id":"e3-6","source":"3","target":"6","type":"smoothstep"},{"id":"e3-7","source":"3","target":"7","type":"smoothstep"}]}'
